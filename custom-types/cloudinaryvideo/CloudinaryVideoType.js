...
cloudinaryvideo.properName = 'CloudinaryVideo';
util.inherits(cloudinaryvideo, FieldType);

cloudinaryvideo.prototype.getProperties = function(){
    return {
        cloudinaryPreset: keystone.get('cloudinary preset'),
        cloudinaryName: keystone.get('cloudinary name'),
        cloudinaryApiEndpoint: '/' + keystone.get('admin path') + '/api/cloudinary/get',
    }
};
 ...
 */
cloudinaryvideo.prototype.getFolder = function () {
	var folder = null;
 ...
 */
cloudinaryvideo.prototype.addToSchema = function (schema) {
	...
	var src = function (item, options) {
        ...
        // if (!('cloudinaryPreset' in options) && keystone.get('cloudinary preset')) {
        //     options.preset = true;
        // }
        // if (!('cloudinaryName' in options) && keystone.get('cloudinary name')) {
        //     options.preset = true;
        // }
 ...
 */
cloudinaryvideo.prototype.getData = function (item) {
 ...
 */
cloudinaryvideo.prototype.validateInput = function (data, callback) {
 ...
 */
cloudinaryvideo.prototype.validateRequiredInput = function (item, data, callback) {
 ...
 * Deprecated
 */
cloudinaryvideo.prototype.inputIsValid = function () {
	return true;
};
 ...
 */
cloudinaryvideo.prototype.updateItem = function (item, data, files, callback) {

	//console.log('CloudinaryVideo:updateItem', item, data, files, callback);
...
cloudinaryvideo.prototype.getRequestHandler = function (item, req, paths, callback) {
	...
	return function () {
		...
		if (req.body && req.body[paths.select]) {
			console.log('req.body paths select', paths, paths.select, req.body[paths.select]);
...
/* Export Field Type */
module.exports = cloudinaryvideo;
