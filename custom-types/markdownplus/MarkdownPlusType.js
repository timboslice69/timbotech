 ...
 * @api public
 */
function markdownplus (list, path, options) {
...
util.inherits(markdownplus, FieldType);


markdownplus.prototype.validateInput = TextType.prototype.validateInput;
markdownplus.prototype.validateRequiredInput = TextType.prototype.validateRequiredInput;

/**
 * Registers the field on the List's Mongoose Schema.
 *
 * Adds String properties for .md and .html markdownplus, and a setter for .md
 * that generates html when it is updated.
 */
markdownplus.prototype.addToSchema = function (schema) {
 ...
 */
markdownplus.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 */
markdownplus.prototype.format = function (item) {
 ...
 */
markdownplus.prototype.getData = function (item) {
 ...
 * Deprecated
 */
markdownplus.prototype.inputIsValid = function (data, required, item) {
 ...
 */
markdownplus.prototype.isModified = function (item) {
 ...
 */
markdownplus.prototype.updateItem = function (item, data, callback) {
